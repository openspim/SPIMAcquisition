 ...
 */
   ...
   // pin connected to DIN of TLV5618s
   int dataPin = 3;
   // pin connected to SCLK of TLV5618s
   int clockPin = 4;
   // pin connected to CS of TLV5618s
   int latchPin_DAC1 = 5;
   int latchPin_DAC2 = 6;
   int latchPin_DAC3 = 7;
 ...
 void setup() {
   ...
   pinMode (latchPin_DAC1, OUTPUT);
   pinMode (latchPin_DAC2, OUTPUT);
   pinMode (latchPin_DAC3, OUTPUT);
   pinMode(8, OUTPUT);
   pinMode(9, OUTPUT);
   pinMode(10, OUTPUT);
   pinMode(11, OUTPUT);
   ...
   digitalWrite(latchPin_DAC1, HIGH);
   digitalWrite(latchPin_DAC2, HIGH);
   digitalWrite(latchPin_DAC3, HIGH); 
 }
...
void analogueOut(int channel, byte msb, byte lsb) 
{
  ...
  switch (channel) {
   case 0:
   digitalWrite(latchPin_DAC1, LOW); 
    msb |= B10000000;
    break;
   ...
   case 2:
    digitalWrite(latchPin_DAC2, LOW); 
    msb |= B10000000;
   break;
   ...
   case 4:
    digitalWrite(latchPin_DAC3, LOW); 
    msb |= B10000000;
   break;
